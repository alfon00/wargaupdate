...
<div {{ $attributes->merge(['class' => 'lw-footer-disclaimer']) }}>
    <p class="lw-footer-disclaimer-text">Portal RT — bukan situs Dukcapil/Kemendagri. Hanya untuk surat pengantar RT. Layanan portal ini gratis untuk warga. Tidak meminta kartu kredit, PIN bank, atau OTP pembayaran.</p>
</div>
@else
<div {{ $attributes->merge(['class' => 'rounded-lg border border-emerald-200 lw-surface px-4 py-3 text-xs text-slate-700 leading-relaxed']) }}>
    <p class="font-semibold text-emerald-900">Portal RT — bukan situs Dukcapil/Kemendagri</p>
