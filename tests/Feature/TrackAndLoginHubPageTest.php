...
class TrackAndLoginHubPageTest extends TestCase
{
    ...
    public function test_login_hub_uses_auth_split_layout(): void
    {
        ...
        $response->assertDontSee('lw-auth-hero', false);
        $response->assertDontSee('id="auth-hero-heading"', false);
        $response->assertDontSee('Akses Pengurus RT &amp; Kelurahan', false);
        $response->assertSee('Masuk ke panel', false);
        $response->assertDontSee('← Beranda', false);
        $response->assertSee('lw-track-hero-grid lw-track-hero-grid--solo', false);
        $response->assertDontSee('class="lw-track-intro"', false);
        $response->assertDontSee('class="lw-track-benefits"', false);
        $response->assertDontSee('Sesi terenkripsi', false);
        $response->assertSee('Email pengurus', false);
        $response->assertSee('pengurus RT atau kelurahan', false);
        $response->assertDontSee('Panel RT atau kelurahan', false);
        $response->assertDontSee('pengurus RT atau admin', false);
        $response->assertDontSee('Panel RT atau admin', false);
